  ...
  `{directPicked}
                                                                                    {pickedInChildren > 0 && (
                                                                                        <div className="group relative inline-flex items-center ml-1">
                                                                                            ...
                                                                                            <div className="absolute left-1/2 -top-2 transform -translate-y-full -translate-x-1/2 w-max max-w-[200px] bg-slate-800 text-white text-[10px] rounded shadow-lg p-2 opacity-0 group-hover:opacity-100 pointer-events-none z-50 text-center font-normal whitespace-normal">
